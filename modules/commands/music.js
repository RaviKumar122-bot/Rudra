...
api.sendMessage(txt, threadID, null, loadingMsg.messageID);
}

setTimeout(()=>progress("45% 🔍 Searching song..."),700);
setTimeout(()=>progress("60% ⚙️ Fetching data..."),1400);
setTimeout(()=>progress("80% 📥 Preparing download..."),2100);
setTimeout(()=>progress("100% ✅ Ready"),2800);
